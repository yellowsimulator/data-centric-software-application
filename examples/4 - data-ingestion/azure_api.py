...
smirk =  emojis.encode(':smirk:')
coffee = emojis.encode(':coffee:')
...
if __name__=='__main__': 
    ...
    data = glob("../log_data/**/**/**")
    file_to_upload = data[0]
    directory_name = os.path.dirname(data[0]).strip('../')
    directory_name = f'01-raw/{directory_name}'
    #create_directory(container_name, directory_name)
